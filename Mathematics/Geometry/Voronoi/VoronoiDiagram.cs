// modified version of MPL licensed code from: https://code.google.com/p/fortune-voronoi/
// license follows:
...
namespace AutomationLibrary.Mathematics.Geometry.Voronoi
{
    public class VoronoiDiagram
    {
        ...
        internal class VEdgeNode : VNode
        {
            ...
            {
                if (!Flipped)
                    return Math.Round(x - ParabolicCut(Edge.LeftData.X, Edge.LeftData.Y, Edge.RightData.X, Edge.RightData.Y, ys), 10);
                return Math.Round(x - ParabolicCut(Edge.RightData.X, Edge.RightData.Y, Edge.LeftData.X, Edge.LeftData.Y, ys), 10);
            }
        }
        ...
        internal class VCircleEvent : VEvent
        {
            ...
            public override double Y
            {
                get
                {
                    return Math.Round(Center.Y + Vector2.DistanceBetweenPoints(NodeN.DataPoint, Center), 10);
                }
            }
